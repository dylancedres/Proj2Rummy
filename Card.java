...
public class Card implements Comparable {
   ...
   // Instead of using the Cards provided by the original code, 
   // my code uses the design of Deck Cards downloaded from
   // https://opengameart.org/content/playing-cards-vector-png
   // static String directory = "cards/";
   static String directory = "myCards/";
   ...
   * Cards are ordered by their rank value.
